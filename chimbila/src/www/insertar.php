...
if ($_POST["audio_id"]=='4.5.wav'){ //COMPROBAMOS LA RECEPCIÓN DEL AUDIO POR POST.
    ...
    $audio_id = mysqli_query($db,"select id from audio where nombre_original='$audio_nombre'");
    ...
    //utf8_encode($otracosa);    //SE TIENE QUE HACER ESTO PARA HALAR LAS TILDES DESDE MYSQL.
    $bool=true;
