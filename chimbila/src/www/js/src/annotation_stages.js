...
AnnotationStages.prototype = {
    ...
    setAnnotations: function(annotationData){
        ...
        var etiquetas = {
            ...
            6:"Frecuencia cuasi-constantes (QCF)"
        }
        //for (var anotacion_id in annotationData){
            var regionData = {
                'start': annotationData.start,
                'end': annotationData.end,
                'annotation': etiquetas[annotationData.annotation],
                'proximity': etiquetas[annotationData.proximity]//,
                //'':r
            };
            (JSON.stringify(regionalertData));
