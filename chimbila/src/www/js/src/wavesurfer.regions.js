...
WaveSurfer.Regions = {
    ...
    /* Add a region. */
    add: function (params) {
        //alert("Inicia la creación de una nueva.");
    ...
    enableDragSelection: function (params) {
        ...
        var start;
        var region;
        //alert("Dentro de la función enableDragSelection 1"); ///////////////////////////////
        function eventDown(e) {
            //alert("Dentro de la función eventDown");            ///////////////////////////////////
            drag = true;
        ...
        //alert("Dentro de la función enableDragSelection 2");            ///////////////////////////
        function eventUp(e) {
            drag = false;
            //alert("Dentro de la función eventUp");            //////////////////////////////
            if (region) {
                //alert("Dentro del if");                                      ///////////////////////
                region.fireEvent('update-end', e);
                my.wavesurfer.fireEvent('region-update-end', region, e);
            }
            //alert("antes de salir de la función eventUp");      /////////////////////////
            region = null;
        }
        document.body.addEventListener('mouseup', eventUp);
        this.wrapper.addEventListener('touchend', eventUp);
        this.on('disable-drag-selection', function() {
            //alert("Dentro de la función disable-drag-selection"); //////////////////////////
            my.wrapper.removeEventListener('touchend', eventUp);
            document.body.removeEventListener('mouseup', eventUp);
        });
        function eventMove(e) {
            //alert("Dentro de la función eventMove");            ///////////////////
            if (!drag) { return; }

            if (!region) {
                //alert("Dentro del if dentro del eventMove");        ////////////////////
                region = my.add(params || {});
                //alert("Antes de salir del if dentro del eventMove");        ////////////////////
            }
